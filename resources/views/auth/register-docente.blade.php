...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/registro-docente.css') }}">
    <!-- Incluye Alpine.js -->
...
<body>
    <div class="container">
        <section class="imagen-lateral">
            <img src="{{ asset('imagenes/fondo-docente.png') }}" alt="Imagen decorativa">
        </section>
        ...
        <section class="registrarse">
            ...
            <div class="formulario-registrar">
                ...
                <form method="POST" action="{{ route('register-docente') }}">
                @csrf
                    <div class="nombres">
